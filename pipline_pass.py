...
ext_query_txs = ["я закончил курс и не получил диплом, где мой диплом", "отпишите меня от ваших ебучих рассылок", "африканский носорог опасный зверь", "москва - столица санкт-петербурга", "пусть бегут неуклюжи пешеходы по лужам, а вода по асфальту рекой"]
